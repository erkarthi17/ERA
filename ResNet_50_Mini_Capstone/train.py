...
This script can be run on EC2, SageMaker, or local machines.
"""
...
def main():
    ...
    parser.add_argument('--data-root', type=str, default=None, help='Path to ImageNet data')
    ...
    logger.info("="*80)
    logger.info("Starting ResNet-50 ImageNet Training")
    logger.info("="*80)
    logger.info(f"\n{config}")
